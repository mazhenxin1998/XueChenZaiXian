...
<head>
    ...
    <title>在线学习平台--${courseBase.name}</title>
</head>
...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.mzx.com/#/learning/${courseBase.id}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
	    ...
	    <#if (coursePic.pic)??>
	     <p><img src="${coursePic.pic}" alt="" width="270" height="156"> </p>
	     <#else>
                    ...
                    <div class="learing-box">
                        ...
                        <div class="item-box">
                            <div class="item-list hov" >
                                <div class="infobox">
<#--                                    D:\Study\Web\VSCodeCode\XueChengZaiXian\xc-ui-pc-static-portal\img-->
