package com.mzx.auth.service;

import com.alibaba.fastjson.JSON;
import com.mzx.common.client.XcServiceList;
...
public class AuthService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret) {
        ...
        if(authToken == null){
            ...
            ThrowException.exception(AuthCode.AUTH_LOGIN_APPLYTOKEN_FAIL);
        }
        //用户身份令牌
        ...
        if (!result) {
            ...
            ThrowException.exception(AuthCode.AUTH_LOGIN_TOKEN_SAVEFAIL);
        }
        return authToken;
